        ...
        className={`flex flex-col items-center justify-center w-full min-h-[8rem] border-2 border-dashed rounded-2xl cursor-pointer transition-all group
          ${
            isDragActive
              ...
              : 'border-slate-300 bg-slate-50 shadow-sm hover:shadow-md hover:bg-slate-100 hover:border-blue-500'
          }
      ...
      >
        ...
        {processing ? (
          ...
          <div className="flex flex-col items-center justify-center pt-5 pb-6 pointer-events-none">
            ...
            <p className="mb-2 text-base md:text-lg text-slate-700 font-medium text-center px-4">
